...
public class ManagerRegistrationResponse extends Response {
    private DTOManagerResponse manager;
    private String accessToken;
    private String refreshToken;


    public ManagerRegistrationResponse(ResponseType response, Manager manager, String accessToken, String refreshToken) {
        super(response);
